...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/image-briefs/mixed-public-domain-familiar/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the mixed public and domain-familiar image briefs line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the mixed public and domain-familiar image briefs leaf.

---

# Mixed Public And Domain-Familiar Image Briefs GitHub Discoverable Task

## Objective

Prepare one prompt-ready image brief for a mixed public plus domain-familiar audience inside the prompt-ready educational image brief work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/image-briefs/mixed-public-domain-familiar/001.trace.md)
- Committed Branch Handoff Pattern
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/image-briefs/001-1-cloud-handoff.trace.md)
...
- medium invariant: prompt-ready educational image brief work
- named receiver: a mixed public plus domain-familiar audience
- success condition: one image brief that a cloud model can execute without losing receiver fit
...
- sha256-base64url-c14n-v1
  ...
  - Value: 5DgXdr96W7CugGKoE2Lmz_YoWkp-xfkTb0tWG5yvsXE
