...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/image-briefs/public-facing/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the public-facing image briefs line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the public-facing image briefs leaf.

---

# Public-Facing Image Briefs GitHub Discoverable Task

## Objective

Prepare one prompt-ready image brief for a public-facing educational audience inside the prompt-ready educational image brief work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/image-briefs/public-facing/001.trace.md)
...
- named receiver: a public-facing educational audience
...
- sha256-base64url-c14n-v1
  ...
  - Value: GHGUZmUZE-ltWvVcrJGmXhFgIp7S94HQyaxS4cF_2hk
