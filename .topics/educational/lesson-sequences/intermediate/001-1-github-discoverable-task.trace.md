...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/lesson-sequences/intermediate/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the intermediate lesson sequences line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the intermediate lesson sequences leaf.

---

# Intermediate Lesson Sequences GitHub Discoverable Task

## Objective

Prepare one lesson-sequence brief for intermediate learners with moderate prior context inside the educational sequencing and progression work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/lesson-sequences/intermediate/001.trace.md)
...
- named receiver: intermediate learners with moderate prior context
...
- sha256-base64url-c14n-v1
  ...
  - Value: iE8luUgMhYZ0t7_aHp1tUe1qNbU5_vcbFG50iw2BmUo
