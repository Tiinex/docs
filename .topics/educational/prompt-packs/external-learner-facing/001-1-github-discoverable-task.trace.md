...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/prompt-packs/external-learner-facing/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the external learner-facing prompt packs line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the external learner-facing prompt packs leaf.

---

# External Learner-Facing Prompt Packs GitHub Discoverable Task

## Objective

Prepare one reusable prompt pack draft for external or learner-facing receivers inside the reusable prompt and handoff packet work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/prompt-packs/external-learner-facing/001.trace.md)
...
- named receiver: external or learner-facing receivers
...
- sha256-base64url-c14n-v1
  ...
  - Value: uFA9GwU2MCUTd59PNRLzU3-hQz4EFkE8__nVpXDDBew
