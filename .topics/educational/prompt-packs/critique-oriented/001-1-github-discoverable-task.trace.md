...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/prompt-packs/critique-oriented/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the critique-oriented prompt packs line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the critique-oriented prompt packs leaf.

---

# Critique-Oriented Prompt Packs GitHub Discoverable Task

## Objective

Prepare one reusable prompt pack draft for receivers who need review-first rather than generation-first packets inside the reusable prompt and handoff packet work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/prompt-packs/critique-oriented/001.trace.md)
- Committed Branch Handoff Pattern
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/prompt-packs/001-1-cloud-handoff.trace.md)
...
- medium invariant: reusable prompt and handoff packet work
- named receiver: receivers who need review-first rather than generation-first packets
- success condition: one packet that can guide later cloud or local work without direct clarification questions
...
- sha256-base64url-c14n-v1
  ...
  - Value: -hiPoywnFd934t5r4x4TDWGoSrdKHPrsFbFz9-29ous
