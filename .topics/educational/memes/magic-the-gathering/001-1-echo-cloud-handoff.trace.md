...
- Current
  ...
  - Summary: Task for Echo-role Cloud ChatGPT handoff in the Magic: The Gathering Memes leaf.

---

# Magic: The Gathering Memes Echo Cloud Handoff Task
...
- named leaf: Magic: The Gathering Memes
- governing read: Artifacts here should assume the main signal is Magic: The Gathering recognition: cards, stack logic, rules text, legendary framing, mana-color identity, or collectible-game rhetoric applied to continuity, trace, proof, inheritance, or transfer.
...
- required behavior: synthesize one strong bounded direction that preserves Magic-like rules recognition while making continuity or lineage feel legible and memorable to a broader audience
...
- do not widen to sibling leaves or generic fantasy-card humor just because those are easier to render
- preserve the continuity or lineage point explicitly; do not collapse the concept into aesthetic card cosplay with no rule-bearing meaning
...
- one concrete Magic-framed meme direction, concept frame, or prompt-ready handoff that teaches or dramatizes continuity or lineage through recognizable game logic
...
- the result fits this exact leaf directly, not only the broader memes root
- the result uses recognizable Magic-like framing without requiring literal copyrighted card recreation to carry the joke
- the continuity or lineage signal remains clear enough that later public-facing variants can attach cleanly
...
- do not reduce the concept to pure fantasy flavor with no continuity or lineage point
- do not require literal copyrighted logos or exact card-frame imitation when a strongly adjacent readable frame is enough
...
- sha256-base64url-c14n-v1
  ...
  - Value: RfcTK-7iwEIOrnCdElHVlYYXGYoinakZbYuyu8mZing