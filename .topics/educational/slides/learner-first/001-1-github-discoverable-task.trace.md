...
- Parent
  ...
  - Origin:
    ...
    - [absolute](C:/Users/micro/Documents/Repos/Tiinex/docs/.topics/educational/slides/learner-first/001.trace.md)
- Current
  ...
  - Authors: Anchor
  - Why: Defines the first GitHub-discoverable leaf task for the learner-first slides line so ChatGPT can browse the committed origins and complete a bounded first pass without direct clarification questions.
  - Summary: Task for one-sweep GitHub-discoverable work in the learner-first slides leaf.

---

# Learner-First Slides GitHub Discoverable Task

## Objective

Prepare one slide-ready image brief or handoff packet for learners with limited prior context inside the slide-oriented educational visual work
line.
...
- Committed Leaf Topic
  - Origin:
    - [browse + git](https://github.com/Tiinex/docs/blob/f76e424f7e5e0628efe04226a5ed97425a1301cb/.topics/educational/slides/learner-first/001.trace.md)
...
- sha256-base64url-c14n-v1
  ...
  - Value: _kvo9tbvLzRaBXgfntxSwp_b0lay-PykgNNH2sWW8rQ
